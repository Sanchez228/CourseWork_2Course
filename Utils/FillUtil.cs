        ...
        public static void FillContentGrid(Grid contentGrid, string page)
        {
            ...
            for (int row = 0; row < 24; row++)
            {
                ...
                for (int column = 0; column < 7; column++)
                {
                    ...
                    if (dayOfWeek == DayOfWeek.Saturday| dayOfWeek == DayOfWeek.Tuesday| dayOfWeek == DayOfWeek.Thursday| dayOfWeek == DayOfWeek.Wednesday| dayOfWeek == DayOfWeek.Friday| dayOfWeek == DayOfWeek.Sunday |dayOfWeek==DayOfWeek.Monday)
                    {
